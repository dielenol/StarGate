...
const ICONS: Record<OrgIconCode, IconPath> = {
  ...
  GALLOGLA: {
    /* 갈로글라 — 켈트식 방패 안에 스파스 양손도끼를 새긴 전투 문장. */
    body: `<path d="M12 2.6l7.4 2.8v5.8c0 4.5-2.8 7.8-7.4 10.2-4.6-2.4-7.4-5.7-7.4-10.2V5.4z"/><path d="M12 6.2v11.2"/><path d="M12 6.4C9.8 4.5 7.5 4 5.4 4.9c.4 2.7 2 4.4 4.8 5.2z"/><path d="M8.7 14.4L12 17.7l3.3-3.3L12 11.1z"/>`,
  },
  JOMSVIKING: {
    /* 욤스비킹 — 방패열을 두른 용두 장선. 결사 전통과 해상 원정을 하나의 실루엣으로 묶는다. */
    body: `<path d="M3 15.4h17.5c-1 3.5-4 5.5-8.8 5.5-4.6 0-7.6-2-8.7-5.5z"/><path d="M11.5 3v12.4"/><path d="M11.5 4.2C8.6 5.3 6.7 7.7 6 11.3h5.5z"/><path d="M11.5 4.2c2.9 1.1 4.9 3.5 5.6 7.1h-5.6z"/><path d="M7 8.7h9"/><path d="M20.5 15.4c1.4-.7 2-1.8 1.7-3.2l-1.6 1c.1-1.3-.4-2.3-1.5-3"/><circle cx="7.2" cy="15.7" r="1.2"/><circle cx="11.5" cy="15.7" r="1.2"/><circle cx="15.8" cy="15.7" r="1.2"/>`,
  },
  GOLDEN_DAWN: {
