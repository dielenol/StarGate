  ...
  return (
    <group position={[0, 0.18, 0]}>
      <mesh castShadow receiveShadow position={[0, 0.23, 0]}>
        <cylinderGeometry args={[0.94, 1.08, 0.42, 8]} />
        <meshStandardMaterial color="#1e2a2d" roughness={0.72} metalness={0.34} />
      </mesh>
      <mesh castShadow position={[0, 0.62, 0]}>
        <cylinderGeometry args={[0.46, 0.58, 0.42, 8]} />
        <meshStandardMaterial
          color="#62bfd2"
          emissive="#235a66"
      ...
      <Html center position={[0, 1.32, 0]} className={styles.sceneLabel}>
        <span>ARMORY BUREAU</span>
      </Html>
    </group>
  );
}
