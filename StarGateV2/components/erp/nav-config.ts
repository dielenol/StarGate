...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    label: "인물·조직",
    items: [
      { label: "캐릭터", keywords: "characters person", icon: IconCharacter, href: "/erp/characters" },
      ...
      { label: "명예의 전당", keywords: "hall of fame 연구 공로 ranking", icon: IconCrown, href: "/erp/hall-of-fame" },
    ],
  },
  {
    key: "assets",
  ...
  },
  {
    ...
    minRole: "GM",
    items: [
      { label: "관리자", keywords: "admin discord worker outbox 연동 상태", icon: IconAdmin, href: "/erp/admin" },
      { label: "VTT 운영", keywords: "vtt nochichim runtime server 원격 시작 종료", icon: IconAdminVtt, href: "/erp/admin/vtt" },
      { label: "사용자 관리", keywords: "users admin", icon: IconAdminUsers, href: "/erp/admin/users" },
      { label: "크레딧 운영", keywords: "credits admin grant op pool 작전풀", icon: IconAdminCredits, href: "/erp/admin/credits" },
      { label: "주식 운영", keywords: "stocks admin market price 주식 시세", icon: IconAdminStocks, href: "/erp/admin/stocks" },
      { label: "대사 비프 테스트", keywords: "dialogue beep audio npc hud undertale", icon: IconAdminDialogueBeep, href: "/erp/admin/dialogue-beep" },
      { label: "인벤토리 운영", keywords: "inventory admin grant items 지급 마스터", icon: IconAdminInventory, href: "/erp/admin/inventory" },
      { label: "신규 품목 운영", keywords: "catalog shop armory item 편의점 병기부 품목 등록", icon: IconAdminCatalog, href: "/erp/admin/catalog" },
      { label: "공방 운영", keywords: "equipment workshop upgrade quote 강화 견적", icon: IconArmoryWorkshop, href: "/erp/admin/equipment-workshop" },
      { label: "투표 운영", keywords: "bureaucrat vote registrar 관료 투표 안건", icon: IconAdminVotes, href: "/erp/admin/bureaucrat-votes" },
      { label: "캐릭터 등록", keywords: "character person register import", icon: IconAdminCharacters, href: "/erp/admin/characters/import" },
    ],
  },
];
