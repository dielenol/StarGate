...
export const EXTERNAL_SUB_ORGS: readonly ExternalSubOrg[] = [
  {
    ...
    parentCode: "CIVIL",
    parentLabel: "시민사회",
    logoUrl: "/assets/faction/white_rose_logo.webp",
    logoVariant: "badge",
  ...
  },
  {
    ...
    parentCode: "CIVIL",
    parentLabel: "시민사회",
    logoUrl: "/assets/faction/space_zero_logo.webp",
    logoVariant: "wide",
  ...
  },
  {
    ...
    label: "갈로글라",
    labelEn: "Gallowglass",
    summary: "아일랜드계 전사·용병 공동체",
    parentCode: "MILITARY",
    parentLabel: "군부",
    logoUrl: "",
    logoVariant: "badge",
    doctrine: "전사 전통 · 용병 공동체",
  },
  {
    code: "JOMSVIKING",
    label: "욤스비킹",
    labelEn: "Jomsviking",
    summary: "북유럽계 전사·용병 공동체",
    parentCode: "MILITARY",
    parentLabel: "군부",
    logoUrl: "",
    logoVariant: "badge",
    doctrine: "전사 전통 · 용병 동맹",
  },
  {
    code: "GOLDEN_DAWN",
    label: "황금여명회",
