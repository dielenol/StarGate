...
const MOOD_ASSETS = {
  inspect: "Mateo-Rivas-Ratchet-inspect.webp",
  systems: "Mateo-Rivas-Ratchet-systems.webp",
  dispatch: "Mateo-Rivas-Ratchet-dispatch.webp",
  checkout: "Mateo-Rivas-Ratchet-checkout.webp",
  blocked: "Mateo-Rivas-Ratchet-blocked.webp",
  idle: "Mateo-Rivas-Ratchet-idle.webp",
};
