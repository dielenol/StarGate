...
const FACTION_DEFAULT_SUMMARIES: Record<(typeof FACTIONS)[number]["code"], string> = {
  MILITARY:
    "광원화 사태 이전부터 존재한 군사 권력 블록. 노부스 오르도의 조율주의에 불만을 품고 전통적 군사 권위와 무장 대응을 중시한다.",
  COUNCIL:
    "세계의 부 98%를 차지하는 부자들과 각 정부에 암약하는 권력의 실세들이 창설한 외부 권력 블록. 노부스 오르도의 주요 후원금과 의결 압력을 담당한다.",
    CIVIL:
      "지구의 대부분을 차지하는 시민 세력. 편리함과 생존을 위해 기술의 진보를 바라며, 얄팍하지만 보편적인 선과 인본주의적 판단을 추구하는 외부 권력 블록이다.",
    HOSTILE:
      "노부스 오르도 작전 기록에서 적대 또는 충돌 대상으로 분류되는 비정규 세력군. 공식 3대 외부 권력 블록과 별도로 위협 추적과 작전 대응 대상으로 관리된다.",
    NOVUS_ORDO:
      "광원화 사태 이후 출범한 초인류 국제기구. 외부 3대 권력 블록(군부/세계이사회/시민사회) 위에 별개로 존재하며, 사무국·MANUS 등 내부 기관을 통해 직접 실행 권한을 가진다.",
  };
