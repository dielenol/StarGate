# Equipment Shop World Assets

## Kenney City Kit Suburban 2.0

- Source: https://kenney.nl/assets/city-kit-suburban
- Download used: `kenney_city-kit-suburban_20.zip`
- License: Creative Commons Zero, CC0
- Local files: `kenney-city-kit/*.glb`, `kenney-city-kit/Textures/colormap.png`
- Original license file: `kenney-city-kit/LICENSE.txt`
