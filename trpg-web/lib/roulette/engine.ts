...
export const ROULETTE_MAX_BALLS_PER_PARTICIPANT = 10;
...
export const ROULETTE_COURSES: readonly RouletteCourse[] = [
  ...
  },
  {
    ...
    distance: "원본풍",
    duration: "약 9초",
    description: "분기·지그재그·핀 숲을 잇는 다채 룰렛의 대표 코스",
    height: 1_030,
