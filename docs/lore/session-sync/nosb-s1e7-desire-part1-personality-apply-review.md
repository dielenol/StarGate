---
title: NOSB S1E7 욕구 1부 성격 관찰 적용 확인표
tags: [NOSB-S1E7-DESIRE-PART1, personality, apply-review]
...
이 표는 전체 근거표에 남겨 둔 비공개 관찰 후보를 제외하고, 전체 공개 등록 파일이 실제 신원조회에 추가하는 성격 관찰 8건만 검사한다. 아래 근거 문장은 등록 파일의 값과 그대로 일치한다.
...
|---|---|---|---|---|---|---|---|---|
| `NOSB-S1E7-DESIRE-PART1:WHITE_ROSE_R:strategic-exposure` | `WHITE_ROSE_R` | `NOSB-S1E7-DESIRE-PART1` | 여론과 내부 증거로 조직 정책을 바꾸려는 전략적 폭로 | action + dialogue | R 단말로 해쉬를 한 코너 너머로 안내한 직후 리처드로 직접 대면했다. 파리 카타콤의 감염자 은폐 증거를 확보해 언론에 공개하라고 지시했다. | 작전 보고서 S1E7: 욕구 1부 | confirmed | ready-for-apply |
